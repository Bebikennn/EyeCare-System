...
from services.schema_migrations import ensure_core_tables, ensure_users_columns, ensure_users_password_hash_column
import config
import socket
import logging
import os
...
try:
    ...
    app.logger.exception('Users column migration failed')
